This is a sample project students can use during the Git class.
...
* git@github.com:zombiefish/hello-world.git
* git://github.com/zombiefish/hello-world.git
* https://zombiefish@github.com/zombiefish/hello-world.git
